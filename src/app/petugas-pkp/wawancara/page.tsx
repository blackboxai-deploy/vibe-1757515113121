...
export default function WawancaraPage() {
  // Data verifikasi yang dijadwalkan hari ini
  const [verifikasiHariIni] = useState<VerifikasiHariIni[]>([
    {
      id: 1,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    toast.success('Wawancara berhasil disimpan')
    setShowForm(false)
    ...
    return (
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* CRUD Placeholder untuk Aset, Biaya, Kekurangan Berkas */}
          <Card className="bg-purple-50 border-purple-200">
            <CardHeader>
              <CardTitle className="text-purple-900">CRUD Data Tambahan</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-3 gap-4">
              ...
              <p className="text-sm text-purple-700">
                Klik tombol di atas untuk mengelola data Aset, Biaya Riil, dan Kekurangan Berkas (CRUD functionality)
              </p>
            </CardContent>
          </Card>
